...
public class ViewContactActivity extends Activity
    ...
    protected void onCreate(Bundle icicle) {
       ...
       /* mCallLog = (Button)findViewById(R.id.call_log);
        mCallLog.setOnClickListener(new Button.OnClickListener(){
        	
        	public void onClick(View v){
        		Intent intent=new Intent(ViewContactActivity.this,ViewContactSecondaryActivity.class);
        		intent.setData(mLookupUri);
        		intent.putExtra(Constants.EXTRA_KEY_SHOW_SMS, false);
        		intent.putExtra(Constants.EXTRA_KEY_MOBILE_PHONE, mNumber);
        		startActivity(intent);
        	}
        });
       findViewById(R.id.call_log_layout).setVisibility(0);*/
    ...
    public void onCreateContextMenu(ContextMenu menu, View view, ContextMenuInfo menuInfo) {
        ...
        if (entry.mimetype.equals(CommonDataKinds.Phone.CONTENT_ITEM_TYPE)) {
            menu.add(0, 0, 0, getResources().getString(R.string.recentCalls_callNumber, entry.data)).setIntent(entry.intent);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
        	case R.id.menu_see_contacts:{
    		Intent intent=new Intent(this,ViewContactSecondaryActivity.class);
    		intent.setData(mLookupUri);
    		intent.putExtra(Constants.EXTRA_KEY_SHOW_SMS, false);
    		intent.putExtra(Constants.EXTRA_KEY_MOBILE_PHONE, mNumber);
    		startActivity(intent);
	...
	private synchronized void initHeaderAndBottom() {
		...
		if (mHeadCursor!=null && mHeadCursor.moveToFirst()) {
			...
			name = mHeadCursor.getString(Constants.VIEW_CONTACT_HEADER_COLUMN_INDEX_NAME);
			type = mHeadCursor.getString(Constants.VIEW_CONTACT_HEADER_COLUMN_INDEX_TYPE);
			mNumber = mHeadCursor.getString(Constants.VIEW_CONTACT_HEADER_COLUMN_INDEX_NUMBER);
		} else {
