    ...
    protected DataKind inflatePhone(Context context, int inflateLevel) {
        ...
        if (kind == null) {
            kind = addKind(new DataKind(Phone.CONTENT_ITEM_TYPE, R.string.phoneLabelsGroup,
                    R.drawable.icon_call, 10, true));
            kind.iconAltRes = R.drawable.icon_msg;
...
//         修改处   
            kind.actionHeader = new WebsiteActionInflater();
    ...
    public static class WebsiteActionInflater extends CommonInflater {
//修改处
        @Override
        protected int getTypeLabelResource(Integer type) {
            if (type == null) return R.string.websiteLabelsGroup;
            switch (type) {
                case Website.TYPE_HOMEPAGE: return R.string.websiteLabelsHomePage;
                case Website.TYPE_WORK: return R.string.websiteLabelsWork;
                default: return R.string.websiteLabelsGroup;
            }
        }
    }
